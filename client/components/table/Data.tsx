import { DangerCircleSvg } from "@/components/icons/DangerCircle";
import { DefaultCircleSvg } from "@/components/icons/DefaultCircle";
import { SuccessCircleSvg } from "@/components/icons/SuccessCircle";
import { WarningCircleSvg } from "@/components/icons/WarningCircle";
...
export const INITIAL_VISIBLE_COLUMNS: ColumnsKey[] = [  "workerID",
  "externalWorkerID",
  "memberInfo",
  "country",
  "role",
...
export const columns = [  {name: "Worker ID", uid: "workerID"},
